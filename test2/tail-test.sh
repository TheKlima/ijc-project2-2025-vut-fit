...
test_script_ret_code() {
    ...
    test_file=$(pwd)/tail_tests2025/return/$3.input  # Program input file
    test_args=$(pwd)/tail_tests2025/return/$3.params # Program input file
...
test_script_output(){
    test_description=$1 # The test description
    test_cnt=$2         # Test count
    test_file=$(pwd)/tail_tests2025/output/$3.input  # Program input file
    test_args=$(pwd)/tail_tests2025/output/$3.params  # Program input file
    test_output=$(pwd)/tail_tests2025/output/$3.output  # Program output file
...
test_script_file(){
    test_description=$1 # The test description
    test_cnt=$2         # Test count
    test_args=$(pwd)/tail_tests2025/file/$3.params   # Program input file
    test_output=$(pwd)/tail_tests2025/file/$3.output # Program output file
...
for file in "./tail_tests2025/return"/*.input; do
...
valgrind_result=$(valgrind --leak-check=full ../tail -n 1 < ./tail_tests2025/output/many_lines_1.input 2>&1)
...
valgrind_result=$(valgrind --leak-check=full ../tail -n 1000 < ./tail_tests2025/output/many_lines_1.input 2>&1)
